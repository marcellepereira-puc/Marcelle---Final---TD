# Experimentos ResNet50v2 — usa somente datasets/split
...
from config import EXPERIMENTS_RESNET_DIR, create_model
from train_utils import rodar_experimentos

NOME_MODELO = "resnet50v2"
...
if __name__ == "__main__":
    rodar_experimentos(EXPERIMENTOS, NOME_MODELO, EXPERIMENTS_RESNET_DIR, create_model, "ResNet50v2")

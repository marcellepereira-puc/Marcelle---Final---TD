...
# Garante que o caminho da pasta está dentro do split.
...
# Mapeia o nome da pasta para o nome da label.
...
# Verifica se o split está disponível para o dataset e subset.
...
# Verifica se o split está disponível para o dataset de treino, validação e teste.
...
# Conta o número de imagens do subset (train/val/test) do repositório informado.
